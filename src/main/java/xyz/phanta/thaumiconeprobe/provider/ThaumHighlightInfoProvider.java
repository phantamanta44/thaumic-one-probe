package xyz.phanta.thaumiconeprobe.provider;
...
import xyz.phanta.thaumiconeprobe.ThaumicOneProbeConfig;
...
public class ThaumHighlightInfoProvider implements IProbeInfoProvider {
    ...
    @Override
    public String getID() {
        return ThaumicOneProbeMod.MOD_ID + ":thaum_highlight";
    }
    ...
    public void addProbeInfo(ProbeMode mode, IProbeInfo probeInfo,
        ...
        if (ThaumicOneProbeConfig.requireGoggles && !EntityUtils.hasGoggles(player)) {
            return;
        }
