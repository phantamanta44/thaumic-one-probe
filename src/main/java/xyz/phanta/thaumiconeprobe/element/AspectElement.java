package xyz.phanta.thaumiconeprobe.element;
...
import xyz.phanta.thaumiconeprobe.client.element.AspectElementRenderer;
...
public class AspectElement implements IElement {
    ...
    @Override
    public int getID() {
        return ThaumicOneProbeMod.PROXY.getAspectElementId();
    }
